...
const NavigationBar = () => {
  ...
  return (
    <div style={{ "marginLeft": "0", "marginRight": "0", "width": "99.236438799999999%" }}>
      <div class={`${styles.barcustom, styles.barcontainer} row`}>
        {/* left bar*/}
        ...
        <div className={`${styles.barcustom}  col-sm-7  justify-content-center d-flex flex-column padding-0`}>
          <div>
            <input  type="search" style={{ outline: "none","height": "35px", "width": "100%", "border-radius": "7px", "paddingLeft": "10px","paddingRight":"40px","paddingBottom":"3px"}} className={`${styles.search} `}>
            </input>
            <img type="submit" src={img_search} style={{ "height": "30px", "margin-left": "-35px", "margin-top": "-5px" }} className='border-left-2'/>
          </div>
        ...
        <div style={{ "paddingRight": "0px" }} className={`${styles.barcustom} col-sm-3`}>
          ...
          <div style={{ "height": "60%", "padding": "4px", "marginTop": "0.2%" }} className={`d-flex justify-content-end align-items-center`}>
            ...
            <div className={`${styles.container} `}>
              <button onClick={handleClick} type='submit' className={`${styles.hover} ${styles.button} `} style={{ "height": "40px", "padding-left": "6px", "padding-right": "6px", "marginLeft": "-20px" }}>
            ...
            {/* tk da dang nhap*/}
            <div className={`${styles.container} d-none`}>
              <button type='submit' className={`${styles.hover} ${styles.button} `} style={{ "height": "40px", "padding-left": "12px", "padding-right": "6px" }}>
                <img src={img_avt} style={{ "height": "30px", "marginLeft": "-4px" }} alt="Car Icon" />
                <span className='' style={{ "min-width": "100px" }}>
                  Tài Khoản
                </span>
              </button>
              <ul className={styles.list}>
                ...
                <li><button className={`${styles.hover} ${styles.listaccount}`}>Đăng Xuất</button></li>
              </ul>
            </div>
            {/* dangnhap*/}
            <div className={`${styles.container}`}>
          ...
          <div style={{ "height": "40%" }} className={`justify-content-center  align-items-center d-flex`}>
            <button style={{ "height": "30px" }} type='submit' className={`${styles.hover} ${styles.button} border-0 d-flex align-items-center justify-content-center bg-transparent`}>
              <img src={img_local} style={{ "height": "60%", }} />
              <div style={{}} >
                Giao Đến:
              </div>
            </button>
